...
check_cdn() {
  ...
  local PIDS=()
  local RAW_URL='https://raw.githubusercontent.com/assast/argox/main/argox.sh'
...
bash <(wget --no-check-certificate -qO- ${GH_PROXY}https://raw.githubusercontent.com/assast/argox/main/argox.sh) \$1
EOF
